...
Object.assign(Remote, {
  ...
  offerRestart (message) {
    ...
    const restart = this.createSymbolText("fa fa-fw fa-recycle", this.translate("RESTARTMM"), this.buttons["restart-mm-button"]);
  ...
  offerReload (message) {
    ...
    restart.children[1].classList.add("text");
    wrapper.append(restart);
    const reload = this.createSymbolText("fa fa-fw fa-globe", this.translate("REFRESHMM"), this.buttons["refresh-mm-button"]);

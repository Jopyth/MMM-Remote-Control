...
export default defineConfig([
  ...
  { files: ["**/*.css"], plugins: { css }, language: "css/css", extends: ["css/recommended"], rules: { "css/use-baseline": "off" } },
  {
    ...
    extends: [importX.recommended, pluginJsdoc.configs["flat/recommended"], "js/recommended", stylistic.configs.customize({ quotes: "double", semi: true, commaDangle: "never" }), unicorn.configs.recommended],
    rules: {
  ...
  },
  {
    ...
    extends: [importX.recommended, "js/all", stylistic.configs.customize({ quotes: "double", semi: true, commaDangle: "never" }), unicorn.configs.recommended],
    rules: {
      "@stylistic/array-element-newline": ["error", "consistent"],
      "@stylistic/indent": ["error", 2],
      "@stylistic/object-property-newline": ["error", { allowAllPropertiesOnSameLine: true }],
